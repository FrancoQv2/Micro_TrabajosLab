...
soltar_F1:
    ...
    BEQ soltar_F1               //Si el botón continua apretado, repito el lazo
...
soltar_F2:
    ...
    BEQ soltar_F2               //Si el botón continua apretado, repito el lazo
...
soltar_Aceptar:
    ...
    MOV R3,#3                   //Si el boton ya se soltó, pongo la unidad de los segundos en 3
    ...
    STRB R3,[R8]                //Guardo el valor 3 en la unidad de los segundos
    //Apago ambos leds
...
disminuye:
    ...
    PUSH {R5-R6,LR}             //Si la bandera está en 1, guardo el estado y llamo a la rutina para disminuir
    BL disminuir                 //Rutina para disminuir el segundo
    POP {R5-R6,LR}              //Recupero el estado actual al salir del pograma
salir_disminuye:

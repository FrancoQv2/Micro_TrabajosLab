...
hora:
    .byte 0x01              // Vector correspondiente a los segundos
...
soltar_F1:
    ...
    BNE seguir_F1                //Espera que la suelte para vovler a participar
...
soltar_F2:
    CMP R7,#1                    //Si se presionó antes de tiempo no lo toma como ganador
    BNE seguir_F1                //Espera que la suelte para vovler a participar
    MOV R9,#2                    //Si se presionó correctamente el ganador es el 2
    B stop
seguir_F2:
    LDR R3,[R4,#BOTONES_OFFSET] //Recupero el estado de los botones desde el GPIO5
    MOV R2,R3
...
disminuye:
    ...
    PUSH {R0-R6,LR}             //Si la bandera está en 1, guardo el estado y llamo a la rutina para disminuir
    BL disminuir                 //Rutina para disminuir el segundo
    POP {R0-R6,LR}              //Recupero el estado actual al salir del pograma
salir_disminuye:

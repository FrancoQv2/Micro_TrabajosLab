...
.equ LED_OFFSET, ( 4 * LED_GPIO ) // ( LED_GPIO0 << 2 ) 
...
LDR R1,=GPIO_CLR0   //Registro del GPIO, limpia
LDR R0,=LED_MASK
STR R0,[R1,#LED_OFFSET]
// Se apagan los bits gpio correspondientes a los leds 1 al 3
LDR R0,=LED_1_MASK
...
LDR R1,=SYST_CSR  //registro de control y estados
MOV R0,#0x00      //pone todos los bits de las configuraciones en 0
STR R0,[R1] // Se quita el bit ENABLE
// Se configura el desborde para un periodo de 100 ms
LDR R1,=SYST_RVR  //Compara con CVR hasta que sean iguales y recarga
LDR R0,=#(480000 - 1)
...
// Se habilita el SysTick con el reloj del nucleo
LDR R1,=SYST_CSR
MOV R0,#0x07  //bits del registro del control y estado
